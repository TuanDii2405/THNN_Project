...
| Luồng chính    | 1. Truy cập đăng ký \        |

2. Nhập thông tin, chụp ảnh \
3. Gửi ảnh lên AI backend \
4. Backend kiểm tra, lưu, mã hóa \
5. Thông báo kết quả |
...
| Luồng chính    | 1. Nhập username, password \  |

2. Backend xác thực \
3. Tạo session, chuyển hướng |
...
| Luồng chính    | 1. Truy cập đăng nhập \            |

2. Chụp ảnh \
3. Gửi ảnh lên AI backend \
4. Backend xác thực, chuyển hướng |
...
| Luồng chính    | 1. Truy cập dashboard \ |
...
| Tiền điều kiện | Đã đăng nhập                    |
| Luồng chính    | 1. Truy cập cập nhật KYC \      |

2. Upload ảnh giấy tờ \
3. Gửi lên AI backend OCR \
4. Lưu thông tin |
...
| Actor          | Người dùng, AI backend           |
| Tiền điều kiện | Đã đăng nhập                     |
| Luồng chính    | 1. Truy cập cập nhật khuôn mặt \ |

2. Chụp ảnh mới, gửi AI backend \
3. AI trích xuất encoding, trả về backend \
4. Backend cập nhật, xác nhận |
...
| Actor          | Người dùng                 |
| Tiền điều kiện | Đã đăng nhập               |
| Luồng chính    | 1. Truy cập đổi mật khẩu \ |

2. Nhập mật khẩu cũ/mới \
3. Backend xác thực, cập nhật \
4. Thông báo kết quả |
...
| Luồng chính    | 1. Truy cập chuyển khoản \ |

2. Nhập thông tin nhận, số tiền \
3. Backend kiểm tra, xác thực \
4. Cập nhật số dư, ghi giao dịch \
5. Thông báo |
...
| Actor          | Người dùng            |
| Tiền điều kiện | Đã đăng nhập          |
| Luồng chính    | 1. Truy cập lịch sử \ |

2. Backend truy vấn \
3. Hiển thị danh sách, lọc |
...
| Actor                                       | Người dùng                         |
| Tiền điều kiện                              | Đã đăng nhập                       |
| Luồng chính                                 | 1. Nhấn đăng xuất \                |
| 2. Backend xóa session, chuyển về đăng nhập |
...
| Luồng chính    | 1. Truy cập giao diện quản trị \ |

2. Truy vấn danh sách user \
3. Hiển thị danh sách, trạng thái, thao tác |
...
| Actor          | Admin                         |
| Tiền điều kiện | Đã đăng nhập với quyền admin  |
| Luồng chính    | 1. Chọn tài khoản cần duyệt \ |
...
| Actor          | Admin                           |
| Tiền điều kiện | Đã đăng nhập với quyền admin    |
| Luồng chính    | 1. Chọn tài khoản cần từ chối \ |
...
| Actor          | Admin                                |
| Tiền điều kiện | Đã đăng nhập với quyền admin         |
| Luồng chính    | 1. Thao tác khóa/mở khóa tài khoản \ |

2. Backend cập nhật trạng thái \
3. Thông báo kết quả |
...
| Actor          | Admin                                   |
| Tiền điều kiện | Đã đăng nhập với quyền admin            |
| Luồng chính    | 1. Chọn tài khoản cần reset khuôn mặt \ |
...
| Actor          | Admin                        |
| Tiền điều kiện | Đã đăng nhập với quyền admin |
| Luồng chính    | 1. Chọn tài khoản cần xóa \  |
...
| Actor          | Admin                                |
| Tiền điều kiện | Đã đăng nhập với quyền admin         |
| Luồng chính    | 1. Truy cập danh sách hồ sơ đã xóa \ |

2. Backend truy vấn archive \
